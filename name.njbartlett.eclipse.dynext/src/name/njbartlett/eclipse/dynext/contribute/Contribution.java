...
import name.njbartlett.eclipse.dynext.contribute.internal.ContributionFragment;
import name.njbartlett.eclipse.dynext.contribute.internal.FactoryInjector;
import name.njbartlett.eclipse.dynext.contribute.internal.IdInjectionDocumentModifier;
...
public class Contribution {
	...
	public static Contribution loadContribution(InputStream stream, Bundle bundle) throws ContributionProcessingException, IOException {
	...
	public boolean install(IExtensionRegistry registry, String name, Object token) {
		...
		try {
			...
			return registry.addContribution(new ByteArrayInputStream(outputStream.toByteArray()), contributor, false, name, null, token);
		} catch (IOException e) {
	...
	/**
	 * @param registry The extension registry from which to uninstall
	 * @param token The registry token ({@code null} if Eclipse is launched with {@code -Declipse.registry.nulltoken=true}).
	 */
	...
	public void setFactoryObject(String id, IExecutableExtensionFactory factory) throws ContributionProcessingException {
